								...
								<div class="col-md-6">
										...
										<div class="flex-allCenter innerContainer">
												...
												<div class="mw100">
														...
														<div class="form-group">
																<input type="email" id="email" name="email" value="" class="form-control" placeholder="Email" validateEmail="Ingrese un email válido" validateMinLength="4///El email debe contener 4 caracteres como mínimo." tabindex="4" validateFromFile="/ajax/user/validateemail///El email ya existe">
														</div>

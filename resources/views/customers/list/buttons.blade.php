@section( 'action_buttons' )
		...
		<!-- Delete Selected -->
		<button type="button" aria-label="Eliminar Seleccionados" msgok="¡Los clientes han sido eliminadas con éxito!" msgerror="Hubo un error al intentar eliminar los clientes." msgquestion="¿Desea eliminar los clientes seleccionados?" class="btn bg-red animated fadeIn NewElementButton Hidden DeleteSelectedElements hint--bottom hint--bounce hint--error"><i class="fa fa-trash-o"></i></button>
		<!-- Activate Selected -->
		<button type="button" aria-label="Activar Seleccionados" msgok="¡Los clientes han sido activados con éxito!" msgerror="Hubo un error al intentar activar los clientes." msgquestion="¿Desea activar los clientes seleccionados?" class="btn btn-green animated fadeIn NewElementButton Hidden ActivateSelectedElements hint--bottom hint--bounce hint--success"><i class="fa fa-check-circle"></i></button>
		<!-- Expand Selected -->

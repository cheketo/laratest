@section( 'search_fields' )
		...
		<div class="input-group col-lg-3 col-md-3 col-sm-5 col-xs-11" style="margin:2px;">
				...
				<div class="input-group col-lg-3 col-md-3 col-sm-5 col-xs-11" style="margin:2px;">
						...
						<input id="career_id" name="career_id" value="{{ app( 'request' )->input( 'career_id' ) }}" class="form-control" validateonlynumbers="Ingrese únicamente números." placeholder="ID de Grupo" type="text">

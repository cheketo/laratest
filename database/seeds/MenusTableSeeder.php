...
class MenusTableSeeder extends Seeder
{
    ...
    public function run()
    {
				...
				// Clientes
				$menu = new Menu();
				$menu->title_menu = 'Clientes';
				$menu->title_tab 	= 'Clientes';
				$menu->title_page = 'Clientes';
				$menu->icon 			= 'far fa-building';
				$menu->position 	= 10;
				$menu->save();

				// Clientes Listar
				$parent = Menu::where( 'title_menu', 'Clientes' )->first();
				$route 	= WebRoute::where( 'name', 'customer_list' )->first();
				$menu = new Menu();
				$menu->title_menu = 'Listado';
				$menu->title_tab 	= 'Listado de Clientes';
				$menu->title_page = 'Clientes';
				$menu->icon 			= 'far fa-building';
        ...
        // Clientes Crear
				$parent = Menu::where( 'title_menu', 'Clientes' )->first();
				$route 	= WebRoute::where( 'name', 'customer_create' )->first();
				$menu = new Menu();
				$menu->title_menu = 'Crear';
				$menu->title_tab 	= 'Crear Cliente';
				$menu->title_page = 'Cliente';

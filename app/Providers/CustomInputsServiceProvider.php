...
class CustomInputsServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
				...
				Form::component( 'hint', 'components.hint',[ 'text', 'position' => 'bottom-right', 'icon' => 'question-circle', 'icon' => 'fa fa-question-circle' , 'color' => 'info', 'background' => 'info', 'effect' => 'bounce' ] );
